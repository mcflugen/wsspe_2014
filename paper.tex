...
component projects.
%Ccaffeine is a CCA-compliant framework for linking
...
%\csdms{} has also developed a web-based client through which users 
...
and the benifit to the developer should be clear.
...
%\csdms{} is a strong advocate of truly open source software.
...
%\csdms{} acts as a venue through which open source code of
%earth surface models are promoted, either by hosting or pointing towards open
%source software.

%A Digital Object Identifier (\doi{}) system is implemented to
...
%maintain metadata.
%\csdms is among the first software venues to assign \doi{}s to
...
\begin{comment}
\csdms{} requests its \doi{}s through the Integrated Earth Data Applications,
%(\textsc{IEDA}),
...
%In a component-based modeling framework, like \csdms{},
...
(\wmt{}) is a web
%is the web-based successor to the desktop Component Modeling Tool. \wmt{} 
...
%\section{The \csdms Modeling Framework}

\section{Education and Evaluation of \csdms{} Tools}
\label{sec:education}


%\subsection{CSDMS has an educational mission}
%\subsection{Education and Evaluation}
...
%Focused hands-on clinics at meetings also allowed more than 150 CSDMS members to experience the ease of use of \wmt{}, and try several examples of how to use the tool. 
